...
>   - Advanced:
>     ③ Setting Up the Front and Back of Flashcards (this page)
> - Scientific Review:
>   - Beginner essentials:
>     ① Scientific Review Based on the FSRS Anti-Forgetting Algorithm
>   - Advanced:
>     ② Tracing the Source Context

**On This Page**

On the previous page, [Making Flashcards ①: Getting to Know Flashcards and Review Card Decks](../auMvW4AbuCoxDmYipisYoS/index.md), you learned how to create your first flashcard. This page will teach you:
...
> 💡 Before adding cards to review, make sure the current study set is already bound to a review card deck. If you already created a review card deck on the previous page, [Making Flashcards ①: Getting to Know Flashcards and Review Card Decks](../auMvW4AbuCoxDmYipisYoS/index.md), the study set was bound automatically and you can skip this step.
...
![Open Add to Review Card Deck Open Add to Review Card Deck ](image/0bded0c392bb37bc.webp)

![Select the review card deck to bind Select the review card deck to bind ](image/b0b6a65a42eb85c5.webp)
...
![Add a single card to review: select the card Add a single card to review: select the card ](image/0a791fa83cb33bd0.webp)
...
> **What is the Card Grouping Board:** A powerful card-management tool that can filter cards by many criteria, including source, tag, color, document, and creation date. For detailed usage, see: [Card Grouping Board ①: Precisely Filtering from a Large Number of Cards](../dJvh1K4GEKaJYtZ14zbfgj/index.md)

**Steps:**

1. Tap the `Card Grouping Board` icon in the mind map sidebar
2. Choose filter criteria:
   - Filter by `Card Source`: study set, mind map, document
   - Filter by `Grouping`: color, tag, document, document table of contents, creation date, modification date, title link, and more
   - Or use the search box to filter by keyword
3. After filtering down to the target cards, **select** them
4. Tap the `Add to Review` button in the pop-up menu at the bottom

![Usage example: in the Card Grouping Board, filter a set of cards from the "Example Study Set" tagged "#Inequality" and add them to review Usage example: in the Card Grouping Board, filter a set of cards from the "Example Study Set" tagged "#Inequality" and add them to review ](image/84c9bec632a9e979.webp)
...
![Enable Override Default Automation Settings, set color and tags as needed, and turn on emphasize/cloze Enable Override Default Automation Settings, set color and tags as needed, and turn on emphasize/cloze ](image/0f069c4fd6db148d.webp)
...
![Text excerpt emphasize example: use the text excerpt tool to excerpt and make a card, then emphasize the characters within it; Text excerpt emphasize example: use the text excerpt tool to excerpt and make a card, then emphasize the characters within it; ](image/e0f6f647feaf9b02.webp)

![Effect of text excerpt emphasis during review: fill-in-the-blank | the emphasized parts will be blanked out Effect of text excerpt emphasis during review: fill-in-the-blank | the emphasized parts will be blanked out ](image/932299e184416921.webp)

![Rectangular excerpt emphasize example: use the rectangular excerpt tool to make a card, then emphasize the characters and image regions within it Rectangular excerpt emphasize example: use the rectangular excerpt tool to make a card, then emphasize the characters and image regions within it ](image/b078233c7a525884.webp)

![Rectangular excerpt emphasize example: after enabling recall mode, the emphasized characters and image regions are occluded. Rectangular excerpt emphasize example: after enabling recall mode, the emphasized characters and image regions are occluded. ](image/ea976d8770cc2d1c.webp)

![Example: when excerpting with the rectangle tool in a document, turn on emphasize/cloze and emphasize the key information in the excerpt Example: when excerpting with the rectangle tool in a document, turn on emphasize/cloze and emphasize the key information in the excerpt ](image/7d21356b15bcc118.webp)

![Example: how this document excerpt looks in the review card deck | fill-in-the-blank flashcard Example: how this document excerpt looks in the review card deck | fill-in-the-blank flashcard ](image/2457e9daf1640e64.webp)

> 💡 Tip: For more ways to use emphasize (such as bulk-emphasizing in a review card deck or setting up cloze groups), see: [Making Flashcards ③: Setting Up the Front and Back of Flashcards](../pBH9BFrgyZgeWJVf3xLyVA/index.md)
...
![Enable AI OCR and set the prompt for Extra Actions Enable AI OCR and set the prompt for Extra Actions ](image/6534aa95668e7f73.webp)

![The front (question) of a flashcard generated by AI OCR The front (question) of a flashcard generated by AI OCR ](image/f17473e9582b48e8.webp)

![ The back (answer) of a flashcard generated by AI OCR  The back (answer) of a flashcard generated by AI OCR ](image/29f4287f95652e45.webp)
...
![](image/ae715dc4396470c0.webp)

![](image/b210e01d2fc90a5c.webp)

![ The front (question) of a flashcard generated by AI Chat  The front (question) of a flashcard generated by AI Chat ](image/22d82161e0ee6245.webp)

![ The back (answer) of a flashcard generated by AI Chat  The back (answer) of a flashcard generated by AI Chat ](image/9e1bfd38de7ade8f.webp)
...
→ **Continue reading**: [Making Flashcards ③: Setting Up the Front and Back of Flashcards](../pBH9BFrgyZgeWJVf3xLyVA/index.md)
