...
![Immersive mode: the toolbar is simplified and the interface is clean and uncluttered, making the most of screen space](image/a5c85f00f1f4782f.webp)

![Classic mode: the toolbar is displayed normally](image/d88317dfd9cd6c67.webp)
...
![How do I enter Immersive mode?](image/93e3011fd58b37c4.webp)

![What Immersive mode looks like](image/da6e8d8a4bf3e38d.webp)
...
![Top toolbar](image/d93e07f4a7bcf22d.webp)
...
![Document in Immersive mode](image/4171fb7d14631ece.webp)

`Mind Map`: toggles/switches the currently displayed mind map.

![Mind map in Immersive mode](image/c8afd9ed1c03650e.webp)
...
![Reading mode toolbar](image/f57a6975e4c4b435.webp)
...
`Title Link`: turns title links on/off for the current study set. For details, see [Card Link ④ | Keyword Title Links: Build Your Personal Dictionary](../aBEbDgL6oDgDT4CeXotdbS/index.md).
...
![Writing & Editing mode toolbar](image/2d41dcc89af6ec52.webp)
...
`Handwriting Annotation Tools`: brush + lasso + eraser. For details on each handwriting annotation tool, see [Handwriting: Write Freely in Documents, Mind Maps, and Cards](../pYzC5dfXtbC7taLgQC3DFs/index.md).

`Hand Tool`: drag the mind map canvas and browse document pages. For details, see [The Hand Tool Pop-up Menu Bar and Its Customization](../iLGrRDRMEQepittcNY4Bun/index.md). You can adjust the order of the brushes under `> More Brushes`.

`Undo` and `Redo`: revert or redo the previous step.

##### 2.1.2.3 Recall Mode Toolbar

![Recall mode toolbar](image/02b26177c3323551.webp)

`Apply Mind Map Hierarchy`: in `recall mode`, the mind map can show card levels as needed.

![Apply Mind Map Hierarchy: Level 3](image/62eefa3a53330493.webp)

![Apply Mind Map Hierarchy: Level 4](image/41ec0e9c8445882b.webp)
...
![Randomly reveal clozes/emphases/mind map cards](image/5760247bfa3ad3bd.webp)

![Reset to the initial recall mode state](image/1a91c0427bb38d96.webp)

`Disable AI Prompts`: tapping cloze content reveals it directly.

`Enable AI Prompts`: cloze content first opens an AI prompt.

![Disable AI Prompts](image/851ce3666b64f338.webp)

![Enable AI Prompts](image/c2fdf63422dac4f9.webp)
...
![Expand the bottom toolbar](image/3a249b9fe95b9cd5.webp)

![Collapse the bottom toolbar](image/268f10390347284f.webp)
...
![Adjusting the document/mind map view ratio in Immersive mode](image/cf5c167b60d17217.webp)

### 2.3 The Research Browser in Immersive Mode

In `Immersive mode`, opening the `Research Browser` panel for selected text, a document excerpt, or a mind map card displays it as a floating window. The window is resizable, making it easy to look up references while you read. For the full features of the `Research Browser`, see [Research Browser View](../sSYs886ZU4gfwVhuBgzNaV/index.md).

![Adjusting the position and size of the Research Browser window in Immersive mode](image/e8f0148a774e81eb.webp)
...
![Document side locator bar](image/f72f95aae88cb777.webp)
...
![Exit Immersive Mode](image/5fa3c18a110a60e8.webp)
